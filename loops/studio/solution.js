...
function askForNumber() {
  mealsRequested = input.question("How many meals would you like to make? ");
  let numMeals = Number(mealsRequested);
  
  /// CODE YOUR SOLUTION TO PART B here ///
while(isNaN(numMeals) || numMeals <= 1 || numMeals >= 6) {
  mealsRequested = input.question("Please enter a number from 1 to 6: "); 
  numMeals = Number(mealsRequested);
}
